...
Parameters will appear in the Run dialog so users can configure them before execution. You can use types like \`str\`, \`int\`, \`float\`, \`bool\`, and even provide \`choices\` for dropdowns.`;
  }
...
Would you like me to help debug a specific error message?`;
  }
